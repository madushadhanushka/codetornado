<div class="userhome-upper">
    <div class="form_container">
        <form method="post" action="<?php echo base_url('index.php/page/createmodule') ?>" class="form-horizontal">
            ...
            <div class="form-group">
                <?php if (isset($formerror_name)) { ?><div class="form-group has-error"><?php } ?>
                    <label for="inputEmail" class="control-label col-xs-2">Module name</label>
                    <div class="col-xs-10">
                        <input type="text" name="pagename"  class="form-control" placeholder="Module name"/>
